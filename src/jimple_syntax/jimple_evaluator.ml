...
class virtual ['a] evaluator default_value = object(self)
  ...
  method eval_declaration : declaration -> 'a =
    ...
    Declaration(_1, _4) ->
    ((List.fold_left self#combine) default_value)
     [((maybe default_value) self#eval_j_type) _1
     ; ((List.fold_left self#combine) default_value)
  ...
  method eval_local_var : local_var -> 'a =
    ...
    _1, _4 ->
    ((List.fold_left self#combine) default_value)
     [((maybe default_value) self#eval_j_type) _1; self#eval_name _4]
  ...
  method eval_parameter_named_option : parameter_named_option -> 'a =
    ...
    ((List.fold_left self#combine) default_value)
     ...
     ; ((maybe default_value) self#eval_identifier) _3]
  ...
  method eval_statement : statement -> 'a =
    ...
    ((List.fold_left self#combine) default_value)
     ...
     ; ((maybe default_value) self#eval_source_location) _3]
  ...
  method eval_statement_inner : statement_inner -> 'a =
    ...
    | Ret_stmt _1 -> ((maybe default_value) self#eval_immediate) _1
    | Return_stmt _1 -> ((maybe default_value) self#eval_immediate) _1
  ...
  method eval_throws_clause : throws_clause -> 'a =
    (maybe default_value)
     ...
     _2 ->
     ((List.fold_left self#combine) default_value)
      ((List.map self#eval_class_name) _2))
