...
Figure~\ref{fig:architecture}. \dinocomment{The picture should now be changed} It is composed by two main
...
\end{verbatim}
\dinocomment{Update notation and spec as in example}
