...
\paragraph{Axioms and Contradictions.} 
Rules with an empty premise can be used to define axioms or to force the termination of a proof
...
%  | |-
%\end{verbatim}
\dinocomment{Gives an example of axiom.}
